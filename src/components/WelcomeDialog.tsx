...
export const WelcomeDialog = () => {
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogContent className="max-w-lg border-2 border-[#10b981] bg-[#1a1f2e] p-6 rounded-xl mx-4">
        <button
          onClick={handleClose}
        ...
        <div className="space-y-3 text-gray-300">
          ...
          <div className="flex items-start gap-2 mt-4 p-3 bg-[#0f1621] rounded-lg border border-blue-500/30">
          ...
          <div className="flex items-start gap-2 p-3 bg-[#0f1621] rounded-lg border border-green-500/30">
